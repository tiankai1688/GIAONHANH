#!/usr/bin/env python3
# Validate admin.html structure with the stdlib html.parser.
# Checks: well-formed parse, balanced tags, required containers present,
# links admin.css, loads api.js, contains the 13 screens + login gate.
import sys
import os
from html.parser import HTMLParser

HTML_PATH = os.path.join(os.path.dirname(__file__), '..', 'app', 'admin.html')
...
def main():
    ...
    required = {
        ...
        'merchants page': 'id="page-merchants"' in html,
        'orders page': 'id="page-orders"' in html,
        'settlement page': 'id="page-settlement"' in html,
        'overview page': 'id="page-overview"' in html,
        'riders page': 'id="page-riders"' in html,
        'coupons page': 'id="page-coupons"' in html,
        'agents page': 'id="page-agents"' in html,
        'settings page': 'id="page-settings"' in html,
        'permissions page': 'id="page-permissions"' in html,
        'notifications page': 'id="page-notifications"' in html,
        'cover page': 'id="page-cover"' in html,
        'emptystates page': 'id="page-emptystates"' in html,
        'drawer': 'id="drawer"' in html,
        'toast wrap': 'id="toastWrap"' in html,
        'lang pill': 'id="langPill"' in html,
        'theme btn': 'id="themeBtn"' in html,
        'agent nav dot': 'id="navAgentDot"' in html,
        'notif nav dot': 'id="navNotifDot"' in html,
    }
    print('\n--- required pieces ---')
    all_present = True
